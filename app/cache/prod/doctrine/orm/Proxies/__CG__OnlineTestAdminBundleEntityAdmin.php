 ...
 */
class Admin extends \OnlineTest\AdminBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'OnlineTest\\AdminBundle\\Entity\\Admin' . "\0" . 'name', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setAdmin($boolean)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdmin', array($boolean));

        return parent::setAdmin($boolean);
    }
