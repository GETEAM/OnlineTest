...
class __TwigTemplate_5f94bb77804ff07fab44c805a010ff3dc79951c3993d5cb33ec3af6b61ea32a5 extends Twig_Template
{
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "eae182a_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_eae182a_0") : $this->env->getExtension('assets')->getAssetUrl("css/eae182a_combox_style_1.css");
            // line 9
    ...
    ";
            ...
            // asset "eae182a"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_eae182a") : $this->env->getExtension('assets')->getAssetUrl("css/eae182a.css");
            echo "    <link rel=\"stylesheet\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"/>
    ";
...
";
    ...
    public function block_admin_main_left($context, array $blocks = array())
    {
        ...
        <li><a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("add_questions", array("examId" => $this->getAttribute((isset($context["exam"]) ? $context["exam"] : null), "id", array()))), "html", null, true);
...
";
    ...
    ";
        // line 33
        if (((isset($context["hasQuestions"]) ? $context["hasQuestions"] : null) == 0)) {
            // line 34
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["question"]) {
            ...
            if (($this->getAttribute($context["question"], "type", array()) == "single_choice_no_img")) {
                ...
                echo nl2br(strtr($this->getAttribute($this->getAttribute((isset($context["questions_content"]) ? $context["questions_content"] : null), $context["key"], array(), "array"), "question_stem", array(), "array"), array(" " => "&nbsp;")));
                echo "</span><br/>
                    ";
                // line 50
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["questions_content"]) ? $context["questions_content"] : null), $context["key"], array(), "array"), "question_options", array(), "array"));
                ...
                echo "</span>
                        ";
                // line 61
                if ($this->getAttribute($this->getAttribute((isset($context["questions_images"]) ? $context["questions_images"] : null), $context["key"], array(), "array"), 0, array(), "array")) {
                    echo "<br/><img src=\"/";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions_images"]) ? $context["questions_images"] : null), $context["key"], array(), "array"), 0, array(), "array"), "html", null, true);
                    echo "\"/>";
                }
                echo "</span><br/>
                    ";
                ...
                foreach ($context['_seq'] as $context["key1"] => $context["question_option"]) {
                    ...
                    echo twig_escape_filter($this->env, $context["question_option"], "html", null, true);
                    echo "</span>";
                    if ((($this->getAttribute($this->getAttribute((isset($context["questions_images"]) ? $context["questions_images"] : null), $context["key"], array(), "array"), ($context["key1"] + 1), array(), "array") != "0") && ($context["question_option"] != ""))) {
                        echo "</br>";
                    }
                    if ($this->getAttribute($this->getAttribute((isset($context["questions_images"]) ? $context["questions_images"] : null), $context["key"], array(), "array"), ($context["key1"] + 1), array(), "array")) {
                        echo "<img src=\"/";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions_images"]) ? $context["questions_images"] : null), $context["key"], array(), "array"), ($context["key1"] + 1), array(), "array"), "html", null, true);
                        echo "\"/>";
                    }
                    echo "</label></pre>
                    ";
                ...
                foreach ($context['_seq'] as $context["key1"] => $context["question_option"]) {
                    ...
                    echo "\"  
                            ...
                            ";
                    // line 79
                    if (twig_in_filter(($context["key1"] + 1), $this->getAttribute((isset($context["mul_choices_answers"]) ? $context["mul_choices_answers"] : null), $context["key"], array(), "array"))) {
                        echo "checked";
                    }
                    echo "/><label  for=\"question_";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["question"], "id", array()), "html", null, true);
    ...
    <div id=\"questions_tool\">
        ";
        // line 313
        if (($this->getAttribute((isset($context["exam"]) ? $context["exam"] : null), "isOverAndSave", array()) == 0)) {
            // line 314
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "8fdb248_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248_0") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248_jquery-ui_1.js");
            // line 340
    ...
    ";
            // asset "8fdb248_1"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248_1") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248_autoTextarea_2.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            // asset "8fdb248_2"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248_2") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248_ajaxfileupload_3.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            // asset "8fdb248_3"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248_3") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248_jquery.combox_4.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            // asset "8fdb248_4"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248_4") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248_questionsAdd_5.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            ...
            // asset "8fdb248"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_8fdb248") : $this->env->getExtension('assets')->getAssetUrl("js/8fdb248.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
