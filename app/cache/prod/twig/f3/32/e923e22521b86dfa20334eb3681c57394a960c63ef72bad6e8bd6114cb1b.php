...
";
    ...
    public function block_function_content($context, array $blocks = array())
    {
        ...
        ";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "student_name", array()), 'row', array("attr" => array("placeholder" => "请输入学号", "autocomplete" => "off")));
        echo "
        ";
        // line 11
        ...
        ";
        // line 12
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "name", array()), 'row', array("attr" => array("placeholder" => "请输入姓名", "autocomplete" => "off")));
        echo "
        ";
        // line 13
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "password", array()), 'row', array("attr" => array("placeholder" => "请输入密码", "autocomplete" => "off")));
        echo "
        ";
        // line 14
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "06f6c0b_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_06f6c0b_0") : $this->env->getExtension('assets')->getAssetUrl("js/06f6c0b_studentAdd_1.js");
            // line 32
    ...
    ";
            ...
            // asset "06f6c0b"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_06f6c0b") : $this->env->getExtension('assets')->getAssetUrl("js/06f6c0b.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
