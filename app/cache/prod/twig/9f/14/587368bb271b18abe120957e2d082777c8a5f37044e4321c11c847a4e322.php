...
";
    ...
    <table id=\"examslist\">
            ...
            <tr>
                ...
                <th>
                    <select id=\"exam_status\">
                        <option value=\"all\" ";
        // line 29
        if (((isset($context["exam_status"]) ? $context["exam_status"] : null) == "all")) {
            echo "selected";
        }
        echo ">全部状态</option>
                        <option value=\"0\" ";
        // line 30
        if (((isset($context["exam_status"]) ? $context["exam_status"] : null) == "0")) {
            echo "selected";
        }
        echo ">进行中</option>
                        <option value=\"1\" ";
        // line 31
        if (((isset($context["exam_status"]) ? $context["exam_status"] : null) == "1")) {
            echo "selected";
        }
        echo ">已结束</option>
                    </select>
        ...
        <tbody>
            ";
        // line 38
        if (((isset($context["hasExams"]) ? $context["hasExams"] : null) == 0)) {
            // line 39
            echo "                <tr>
        ...
        // line 43
        echo "            ";
        if (((isset($context["hasExams"]) ? $context["hasExams"] : null) == 1)) {
            // line 44
            echo "            ";
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "32aeb79_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_32aeb79_0") : $this->env->getExtension('assets')->getAssetUrl("js/32aeb79_jquery.tablesorter.min_1.js");
            // line 133
    ...
    ";
            // asset "32aeb79_1"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_32aeb79_1") : $this->env->getExtension('assets')->getAssetUrl("js/32aeb79_jquery-ui.min_2.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            // asset "32aeb79_2"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_32aeb79_2") : $this->env->getExtension('assets')->getAssetUrl("js/32aeb79_jquery-ui-timepicker-addon_3.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            // asset "32aeb79_3"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_32aeb79_3") : $this->env->getExtension('assets')->getAssetUrl("js/32aeb79_examList_4.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
            ...
            // asset "32aeb79"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_32aeb79") : $this->env->getExtension('assets')->getAssetUrl("js/32aeb79.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
