...
class __TwigTemplate_473f69c25cb4be7ab3cd359280cab74a449d37b9ceca64e475aaa7f863a1cb27 extends Twig_Template
{
    ...
    public function block_admin_main_left($context, array $blocks = array())
    {
        ...
        ";
        // line 8
        if (((isset($context["isRealName"]) ? $context["isRealName"] : null) == "realname")) {
            // line 9
    ...
    <div id=\"exam_infor\" class=\"left_infor\" hidden>
        ...
        // line 26
        echo twig_escape_filter($this->env, (isset($context["isRealName"]) ? $context["isRealName"] : null), "html", null, true);
        echo "</div>
    </div>
    <ul>
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "b01d4ca_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_b01d4ca_0") : $this->env->getExtension('assets')->getAssetUrl("js/b01d4ca_examPrepare_1.js");
            // line 47
    ...
    ";
            ...
            // asset "b01d4ca"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_b01d4ca") : $this->env->getExtension('assets')->getAssetUrl("js/b01d4ca.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"></script>
    ";
