...
class __TwigTemplate_1a9e8f917f527479b411565df35c284702aa0194c028cad366789c1c653ad5ef extends Twig_Template
{
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "7982fac_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7982fac_0") : $this->env->getExtension('assets')->getAssetUrl("_controller/css/7982fac_login_1.css");
            // line 7
    ...
    ";
            ...
            // asset "7982fac"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7982fac") : $this->env->getExtension('assets')->getAssetUrl("_controller/css/7982fac.css");
            echo "    <link rel=\"stylesheet\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"/>
    ";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "\" />
                ...
                <div  style=\"text-align: center;color: #b92c28;\">
                        ";
        // line 26
        if (((isset($context["isAvailabe"]) ? $context["isAvailabe"] : $this->getContext($context, "isAvailabe")) == (-1))) {
            echo "<span>链接有误，请重新打开正确链接</span>
                        ";
        } elseif (((isset($context["isAvailabe"]) ? $context["isAvailabe"] : $this->getContext($context, "isAvailabe")) == 0)) {
            // line 27
        ...
        if (((isset($context["isAvailabe"]) ? $context["isAvailabe"] : $this->getContext($context, "isAvailabe")) == 1)) {
            ...
            // line 39
            echo twig_escape_filter($this->env, (isset($context["isAvailabe"]) ? $context["isAvailabe"] : $this->getContext($context, "isAvailabe")), "html", null, true);
            echo "\"/>
                    </div>
                    <div class=\"formRow\">
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "f4464f9_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_f4464f9_0") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/f4464f9_studentLogin_1.js");
            // line 105
    ...
    ";
            ...
            // asset "f4464f9"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_f4464f9") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/f4464f9.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
