...
class __TwigTemplate_e3453c8faf93049617e22e412f25a2a2803091b382c4425ae30c333d77870580 extends Twig_Template
{
    ...
    public function block_admin_main_left($context, array $blocks = array())
    {
        ...
        <li><a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("add_parts", array("paperId" => $this->getAttribute((isset($context["paper"]) ? $context["paper"] : $this->getContext($context, "paper")), "id", array()))), "html", null, true);
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["part"]) {
                ...
                foreach ($context['_seq'] as $context["key"] => $context["questionId"]) {
                    ...
                    // line 42
                    if (($this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "isMustSelect", array()) == 1)) {
                        // line 43
                        echo "(必选)";
                    } else {
                        // line 44
                    ...
                    echo "(";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "kind", array()), "html", null, true);
                    echo ")</span>
                    ...
                    // line 46
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "isMustSelect", array()), "html", null, true);
                    echo "</span>
                    ...
                    // line 48
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "isOptionShuffle", array()), "html", null, true);
                    echo "</span>
                            ";
                    // line 49
                        ...
                        foreach ($context['_seq'] as $context["key"] => $context["question_option"]) {
                            ...
                            echo "\"  
                                ...
                                disabled 
                                        ";
                            // line 57
                            if (($this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "answer", array()) == ($context["key"] + 1))) {
                                echo "checked";
                            }
                        ...
                        foreach ($context['_seq'] as $context["key1"] => $context["question_option"]) {
                            ...
                            echo "\"  
                                ...
                                disabled 
                                        ";
                            // line 69
                            if (($this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "answer", array()) == ($context["key1"] + 1))) {
                                echo "checked";
                            }
                            echo "/><label  for=\"question_";
                            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["questions"]) ? $context["questions"] : $this->getContext($context, "questions")), $context["questionId"], array(), "array"), "id", array()), "html", null, true);
                        ...
                        foreach ($context['_seq'] as $context["key1"] => $context["question_option"]) {
                            ...
                            echo "\"  
                                ...
                                disabled 
                                        ";
                            // line 80
                            if (twig_in_filter(($context["key1"] + 1), $this->getAttribute((isset($context["mul_choices_answers"]) ? $context["mul_choices_answers"] : $this->getContext($context, "mul_choices_answers")), $context["questionId"], array(), "array"))) {
                                echo "checked";
                            }
                            echo "/><label  for=\"question_";
                            echo twig_escape_filter($this->env, $context["questionId"], "html", null, true);
    ...
    <div id=\"parts_tool\">
        ";
        // line 98
        if (($this->getAttribute((isset($context["paper"]) ? $context["paper"] : $this->getContext($context, "paper")), "usable", array()) == 1)) {
            // line 99
    ...
    <div id=\"dialog_add_part\" title=\"添加试题块\">
        ...
        // line 111
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["kinds"]) ? $context["kinds"] : $this->getContext($context, "kinds")));
...
";
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "56ee2ad_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad_0") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad_jquery-ui_1.js");
            // line 154
    ...
    ";
            // asset "56ee2ad_1"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad_1") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad_autoTextarea_2.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
            // asset "56ee2ad_2"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad_2") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad_ajaxfileupload_3.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
            // asset "56ee2ad_3"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad_3") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad_jquery.combox_4.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
            // asset "56ee2ad_4"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad_4") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad_partsAdd_5.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
            ...
            // asset "56ee2ad"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_56ee2ad") : $this->env->getExtension('assets')->getAssetUrl("_controller/js/56ee2ad.js");
            echo "    <script type=\"text/javascript\" src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : $this->getContext($context, "asset_url")), "html", null, true);
            echo "\"></script>
    ";
