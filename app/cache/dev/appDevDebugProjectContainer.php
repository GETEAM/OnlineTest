...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'onlinetest_admin.info.form.type' => 'getOnlinetestAdmin_Info_Form_TypeService',
            'onlinetest_admin.registration.form.type' => 'getOnlinetestAdmin_Registration_Form_TypeService',
            ...
            'security.firewall.map.context.student' => 'getSecurity_Firewall_Map_Context_StudentService',
            ...
            'security.user.provider.concrete.students' => 'getSecurity_User_Provider_Concrete_StudentsService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', (dirname(dirname(__DIR__)).'/Resources/FOSUserBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OnlineTestAdminBundle', (dirname(dirname(__DIR__)).'/Resources/OnlineTestAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OnlineTestAdminBundle', (dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/AdminBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OnlineTestMainBundle', (dirname(dirname(__DIR__)).'/Resources/OnlineTestMainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OnlineTestMainBundle', (dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'online_test', 'user' => 'root', 'password' => 123, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/MainBundle/Resources/config/doctrine') => 'OnlineTest\\MainBundle\\Entity', (dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/AdminBundle/Resources/config/doctrine') => 'OnlineTest\\AdminBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'OnlineTest\\MainBundle\\Entity');
        $b->addDriver($a, 'OnlineTest\\AdminBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('OnlineTestMainBundle' => 'OnlineTest\\MainBundle\\Entity', 'OnlineTestAdminBundle' => 'OnlineTest\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a3bb32792ec1a7fdc210f27995c2d37ca0d71c83235a6d93b2638caf04879a49');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OnlineTest\\AdminBundle\\Entity\\Admin');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('fenggao@mail.ustc.edu.cn' => 'Joseph'), 'resetting' => array('fenggao@mail.ustc.edu.cn' => 'Joseph'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'onlinetest_admin_info', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OnlineTest\\AdminBundle\\Entity\\Admin');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'onlinetest_admin_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OnlineTest\\AdminBundle\\Entity\\Admin');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OnlineTest\\AdminBundle\\Entity\\Admin');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'OnlineTest\\AdminBundle\\Entity\\Admin');
    }
    ...
    /**
     * Gets the 'onlinetest_admin.info.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OnlineTest\AdminBundle\Form\Type\ProfileFormType A OnlineTest\AdminBundle\Form\Type\ProfileFormType instance.
     */
    protected function getOnlinetestAdmin_Info_Form_TypeService()
    {
        return $this->services['onlinetest_admin.info.form.type'] = new \OnlineTest\AdminBundle\Form\Type\ProfileFormType();
    }

    /**
     * Gets the 'onlinetest_admin.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OnlineTest\AdminBundle\Form\Type\RegistrationFormType A OnlineTest\AdminBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getOnlinetestAdmin_Registration_Form_TypeService()
    {
        return $this->services['onlinetest_admin.registration.form.type'] = new \OnlineTest\AdminBundle\Form\Type\RegistrationFormType();
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.student' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/student'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 1209600, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('always_use_default_target_path' => false, 'default_target_path' => 'admin_homepage', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.students'), 2 => $b, 3 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56ea21ae4ee4f', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c));
    }

    /**
     * Gets the 'security.firewall.map.context.student' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_StudentService()
    {
        $a = $this->get('security.context');
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/student/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/student/logout'));
        $f->addHandler($this->get('security.logout.handler.session'));

        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => 'student_login', 'always_use_default_target_path' => false, 'default_target_path' => 'exam_prepare', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $g->setProviderKey('student');

        return $this->services['security.firewall.map.context.student'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.students'), 2 => $this->get('fos_user.user_provider.username_email'), 3 => $this->get('security.user.provider.concrete.in_memory')), 'student', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'student', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => 'student_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => 'student_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56ea21ae4ee4f', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'student', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'student_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('fenggao@mail.ustc.edu.cn');
        $a->setPassword('gf910923');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('mail.ustc.edu.cn');
        $instance->setPort(25);
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('student', '/student/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/MainBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/AdminBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'OnlineTestAdminBundle:Form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FOSUserBundle', 1 => 'OnlineTestAdminBundle', 2 => 'OnlineTestMainBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/MainBundle/Resources/views'), 'OnlineTestMain');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/OnlineTest/AdminBundle/Resources/views'), 'OnlineTestAdmin');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/login/'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam/isRealname$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam/paper_status$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam/prepare/unrealname'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam/unrealname'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam/submit_paper'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/student/exam'), array(0 => 'ROLE_STUDENT'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.students'), $a, 'student', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ea21ae4ee4f'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $a, 'main', $b, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'ThisTokenIsNotSoSecretChangeIt', 'main'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ea21ae4ee4f')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('role_hierarchy' => array('ROLE_STUDENT' => 'ROLE_STUDENT', 'ROLE_ADMIN' => 'ROLE_USER', 'ROLE_SUPER_ADMIN' => 'ROLE_ADMIN')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.students'), 1 => $this->get('fos_user.user_provider.username_email'), 2 => $this->get('security.user.provider.concrete.in_memory')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('ryan', '$2a$12$w/aHvnC/XNeDVrrl65b3dept8QcKqpADxUlbraVXXsC03Jam5hvoO', array(0 => 'ROLE_USER')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2a$12$HmOsqRDJK0HuMDQ5Fb2.AOLMQHyNHGD0seyjU3lEVusjT72QQEIpW', array(0 => 'ROLE_ADMIN')));

        return $instance;
    }

    /**
     * Gets the 'security.user.provider.concrete.students' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_StudentsService()
    {
        return $this->services['security.user.provider.concrete.students'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'OnlineTest\\AdminBundle\\Entity\\Student', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OnlineTestMainBundle' => 'OnlineTest\\MainBundle\\OnlineTestMainBundle',
                'OnlineTestAdminBundle' => 'OnlineTest\\AdminBundle\\OnlineTestAdminBundle',
            ...
            'mailer_host' => 'mail.ustc.edu.cn',
            'mailer_user' => 'fenggao@mail.ustc.edu.cn',
            'mailer_password' => 'gf910923',
            'locale' => 'zh_CN',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'OnlineTestAdminBundle:Form:fields.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.ustc.edu.cn',
            'swiftmailer.mailer.default.transport.smtp.username' => 'fenggao@mail.ustc.edu.cn',
            'swiftmailer.mailer.default.transport.smtp.password' => 'gf910923',
            ...
            'assetic.bundles' => array(
                0 => 'FOSUserBundle',
                1 => 'OnlineTestAdminBundle',
                2 => 'OnlineTestMainBundle',
            ),
            ...
            'fos_user.model.user.class' => 'OnlineTest\\AdminBundle\\Entity\\Admin',
            'fos_user.profile.form.type' => 'onlinetest_admin_info',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'fenggao@mail.ustc.edu.cn' => 'Joseph',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'onlinetest_admin_registration',
